...
const Privacy = () => (
  <div>
    ...
    Notorious NPM built the Rhyme Doctor app as a Free app. This SERVICE is provided by Notorious NPM at no cost and is intended for use as is.<br />
    ...
    The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is accessible at Rhyme Doctor unless otherwise defined in this Privacy Policy.<br />

    <h4>Information Collection and Use</h4>

    For a better experience, while using our Service, we may require you to provide us with certain personally identifiable information. The information that we request is will be retained by us and used as described in this privacy policy.<br />
    ...
    <a href="https://policies.google.com/privacy?hl=en&gl=us">Google Play Services</a><br />
    Log Data<br />
